...
var Message = (function () {
    ...
    Message.prototype.sendTo = function (destination, routingKey) {
        ...
        var sendMessage = function () {
            return Promise.resolve().then(function () { return destination._channel.publish(exchange, routingKey, _this.content, _this.properties); })
                .catch(function (err) {
...
var Exchange = (function () {
    ...
    Exchange.prototype.publish = function (content, routingKey, options) {
        ...
        return this.initialized.then(function () {
            try {
                return _this._channel.publish(_this._name, routingKey, content, options);
            }
            catch (err) {
...
var Queue = (function () {
    ...
    Queue.prototype.publish = function (content, options) {
        ...
        var sendMessage = function () {
            try {
                return Promise.resolve(_this._channel.sendToQueue(_this._name, content, options));
            }
            catch (err) {
